// ==================================================================================
// الملف الأول: src/main-process/auth-handlers.js (جديد ومعدل)
// الشرح: تم إزالة الاعتماد على مكتبة bcryptjs المحذوفة.
// أصبح الآن يقارن كلمة المرور كنص عادي (admin/admin).
// ==================================================================================
