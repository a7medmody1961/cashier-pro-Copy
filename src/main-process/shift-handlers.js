...
module.exports = (ipcMain, getMainWindow) => {
    ...
    ipcMain.handle('shift:getDetails', (event, shiftId) => {
        try {
            ...
            // ** START: Removed the expenses query that caused the error **
            // If you want to show expenses, you need to decide how they relate to shifts.
            // For now, we'll return an empty array for expenses to prevent the error.
